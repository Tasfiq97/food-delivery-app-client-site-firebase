        ...
        <div className="mt-12">
            <h1 className="text-center text-4xl font-semibold">Please <span className="text-indigo-600">Login</span>  For Order</h1>
              <div className="text-center border-2 mb-20 lg:w-1/2 ml-auto mr-auto mt-14 ">
                  ...
                  <button onClick={handleSignIn} style={{transition:"all 0.2s ease-in"}} className="border-2 p-3 pl-14 pr-14 mt-4 mb-7 bg-gray-500 hover:bg-indigo-600 text-2xl"><FontAwesomeIcon icon={faGoogle}/> Google Sign in</button>
              </div>
        </div>
    );
};

...
const Banner = () => {
    return (
        <div style={{background:`linear-gradient(50deg, rgba( 0, 0, 0,0.68) 60%, rgba(0,0,0,0.68) 40%),url(${bg})`,backgroundRepeat:"no-repeat",backgroundSize:"100% 100%",backgroundAttachment:"fixed"}} className="flex justify-center items-center text-white p-11 ">
...
<p className="mt-2">Serving a lip-smacking food is our passion.</p>
